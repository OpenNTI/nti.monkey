...
class TestPatch(unittest.TestCase):
    ...
    def test_patch(self):
        ...
        assert_that(BTrees.OOBTree.OOTreeSet.max_leaf_size, is_(500))

        assert_that(BTrees.LOBTree.LOBTree.max_internal_size, is_(500))
        assert_that(BTrees.LOBTree.LOBTree.max_leaf_size, is_(500))

        assert_that(BTrees.LOBTree.LOTreeSet.max_internal_size, is_(500))
        assert_that(BTrees.LOBTree.LOTreeSet.max_leaf_size, is_(500))
